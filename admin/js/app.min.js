...
!(function (c, p) {
            ...
            : ((u = u.add(this.parent())),
              this.each(function () {
                  var t,
                      ...
                      n = c(this),
                      e = n.parent(),
                      i = { delay: c(this).data("delay"), hoverDelay: c(this).data("hover-delay"), instantlyCloseOthers: c(this).data("close-others") },
                      a = "show.bs.dropdown",
                      s = c.extend(!0, {}, { delay: 0, hoverDelay: 0, instantlyCloseOthers: !0 }, l, i);
                  function r() {
                      p.clearTimeout(t),
                          p.clearTimeout(o),
        ...
        var t,
            ...
            n =
                ...
                $(".navbar").on("click mousedown mouseup touchstart", "a.has_children", function () {
                    return (
                        $(this).next("ul").hasClass("open_t") && !$(this).parents("ul").hasClass("open_t")
                            ? $(".open_t").removeClass("open_t")
                            : ($(".open_t").not($(this).parents("ul")).removeClass("open_t"), $(this).next("ul").addClass("open_t")),
                        !1
                    );
                }),
            ...
            a =
                ($(window).scroll(function () {
                    i ||
                        (120 < $(window).scrollTop() && (n.addClass("shrink"), e.addClass("bd-scroll"), n.addClass("fixed-top")),
                        $(window).scrollTop() < 121 && (n.removeClass("shrink"), e.removeClass("bd-scroll"), n.removeClass("fixed-top")));
                }),
    ...
    (function (a) {
        function s(t) {
            t = a(t);
            t.prop("disabled") || t.closest(".form-group").addClass("is-focused");
        }
        function o(t) {
            var i = !1;
                ...
                t.closest("label").hover(
                    function () {
                        var t,
                            ...
                            n = a(this).find("input"),
                            e = n.prop("disabled");
                        i && ((t = a(this)), (o = e), (t = t.hasClass("checkbox-inline") || t.hasClass("radio-inline") ? t : t.closest(".checkbox").length ? t.closest(".checkbox") : t.closest(".radio")).toggleClass("disabled", o)),
                            e || s(n);
                    },
                    function () {
                        n(a(this).find("input"));
                ...
                input: function (t) {
                    a(t || this.options.inputElements)
                        ...
                        .each(function () {
                            ...
                            a.each({ "input-lg": "form-group-lg", "input-sm": "form-group-sm" }, function (t, o) {
                                ...
                                n.hasClass("floating-label") &&
                                    ...
                                    n.after("<label " + o + "class='control-label'>" + t + "</label>")),
                ...
                attachInputEventHandlers: function () {
                    ...
                    a(document)
                        .on("keydown paste", ".form-control", function (t) {
                            (void 0 === (t = t).which ||
                                ("number" == typeof t.which && 0 < t.which && !t.ctrlKey && !t.metaKey && !t.altKey && 8 != t.which && 9 != t.which && 13 != t.which && 16 != t.which && 17 != t.which && 20 != t.which && 27 != t.which)) &&
                                a(this).closest(".form-group").removeClass("is-empty");
                        })
                        ...
                        .on("change", ".form-group input", function () {
                            var t,
                                o = a(this);
                            "file" != o.attr("type") && ((t = o.closest(".form-group")), o.val() ? t.removeClass("is-empty") : t.addClass("is-empty"));
                        })
    ...
    (function (s, r, o, n) {
        ...
        var e = "ripples",
            ...
            i = {};
        function a(t, o) {
            ((l = this).element = s(t)), (this.options = s.extend({}, i, o)), (this._defaults = i), (this._name = e), this.init();
        }
        (a.prototype.init = function () {
            var a = this.element;
            a.on("mousedown touchstart", function (t) {
                var o, n, e, i;
                (l.isTouch() && "mousedown" === t.type) ||
                    (a.find(".ripple-container").length || a.append('<div class="ripple-container"></div>'),
                    (o = a.children(".ripple-container")),
                    (n = l.getRelY(o, t)),
                    (t = l.getRelX(o, t)),
                    (n || t) &&
                        ((e = l.getRipplesColor(a)),
                        (i = s("<div></div>")).addClass("ripple").css({ left: t, top: n, "background-color": e }),
                        o.append(i),
                        r.getComputedStyle(i[0]).opacity,
                        l.rippleOn(a, i),
                        setTimeout(function () {
                            l.rippleEnd(i);
                        }, 500),
                        a.on("mouseup mouseleave touchend", function () {
                            i.data("mousedown", "off"), "off" === i.data("animating") && l.rippleOut(i);
                        })));
            });
        }),
            ...
            (a.prototype.getRelX = function (t, o) {
                t = t.offset();
                return l.isTouch() ? 1 === (o = o.originalEvent).touches.length && o.touches[0].pageX - t.left : o.pageX - t.left;
            }),
            (a.prototype.getRelY = function (t, o) {
                t = t.offset();
                return l.isTouch() ? 1 === (o = o.originalEvent).touches.length && o.touches[0].pageY - t.top : o.pageY - t.top;
            }),
            (a.prototype.getRipplesColor = function (t) {
                return t.data("ripple-color") ? t.data("ripple-color") : r.getComputedStyle(t[0]).color;
            }),
            ...
            (a.prototype.rippleEnd = function (t) {
                t.data("animating", "off"), "off" === t.data("mousedown") && l.rippleOut(t);
            }),
            (a.prototype.rippleOut = function (t) {
                t.off(),
                    l.hasTransitionSupport()
            ...
            (a.prototype.rippleOn = function (t, o) {
                var n = l.getNewSize(t, o);
                l.hasTransitionSupport()
                    ? o
                          .css({ "-ms-transform": "scale(" + n + ")", "-moz-transform": "scale(" + n + ")", "-webkit-transform": "scale(" + n + ")", transform: "scale(" + n + ")" })
                          .addClass("ripple-on")
                          .data("animating", "on")
                          .data("mousedown", "on")
                    : o.animate(
            ...
            (s.fn.ripples = function (t) {
                return this.each(function () {
                    s.data(this, "plugin_" + e) || s.data(this, "plugin_" + e, new a(this, t));
                });
            });
...
function tabs() {
    for (var t = $(".nav.nav-tabs"), i = {}, a = {}, o = 0; o < t.length; o++) {
        var n = o + 1,
            ...
            r = ($(s[s.length - 1]).hasClass("ms-tabs-indicator") || ($(t[o]).data("id", n), $(t[o]).append('<span id="i' + n + '" class="ms-tabs-indicator"></span>')), $("#i" + n)),
            l = ((i["tabW" + n] = []), (a["tabL" + n] = []), i["tabW" + n]),
            c = a["tabL" + n],
            p = 0;
        for (m = 0; m < e; m++) (c[m] = p), (l[m] = $(s[m]).width()), $(s[m]).children().hasClass("active") && r.css({ left: c[m] + "px", width: l[m] + "px" }), (p += l[m]);
    }
    $(".nav.nav-tabs > li").click(function (t) {
        for (var o = (s = $(this).parent()).data("id"), n = (s.children().removeClass("current"), $(this).addClass("current"), s.children()), e = 0; e < n.length - 1; e++)
         
     

            $(n[e]).hasClass("current") && $("#i" + o).css({ left: a["tabL" + o][e] + "px", width: i["tabW" + o][e] + "px" });
    });
}
