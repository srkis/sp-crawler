...
function sp_crawler_url_length() {
...
<div style="max-width:1600px;margin:0;" class="container container-full">
    <div class="ms-paper">
            ...
            <div class="col-lg-12 ms-paper-content-container">
                <div class="ms-paper-content">
                    ...
                    <section class="ms-component-section">
                        <h2 class="section-title" style="color:#F44336;">URL Lenght Crawler</h2>

                        <div class="alert alert-danger role="alert">
                            <strong><i style="font-size:24px" class="fa fa-info-circle" aria-hidden="true"></i> !</strong> This tool will help you to find long or short URLs that can negatively impact your site\'s SEO and user experience.
                        </div>
                   ...
                   <div class="form-group row justify-content-start">
                    <div class="col-lg-10">
                        <a href="#" onclick="startUrlLenghtCrawler(event)" id="startUrlLenghtCrawler" class="btn btn-lg btn-raised btn-danger">Start Crawling<div class="ripple-container"></div></a>
                       <input type="hidden" name="startUrlLenghtAction" id="startUrlLenghtAction" value="startUrlLenght">
                    </div>
                </div>
        </fieldset>
        </form>
      ...
      <section class="ms-component-section">
                        ...
                        <div id="results-url-length-container"></div>
                        </div> <!-- /example -->
                        </section>
