...
function sp_crawler_speed_analyze() {
...
<div style="max-width:1600px;margin:0;" class="container container-full">
    <div class="ms-paper">
            ...
            <div class="col-lg-12 ms-paper-content-container">
                <div class="ms-paper-content">
                    ...
                    <section class="ms-component-section">
                        <h2 class="section-title" style="color:#4CAF50;">Speed Analyze Crawler</h2>

                        <div class="alert alert-success role="alert">
                            <strong><i style="font-size:24px" class="fa fa-info-circle" aria-hidden="true"></i> !</strong> This tool will help you to measure the loading times of your webpages and identifies elements that may be slowing them down. Faster loading times lead to better SEO rankings and a more positive user experience.
                        </div>
                   ...
                   <div class="form-group row justify-content-start">
                    <div class="col-lg-10">
                        <a href="#" onclick="startSpeedAnalyzerCrawler(event)" id="startSpeedAnalyzerCrawler" class="btn btn-lg btn-raised btn-success">Start Crawling<div class="ripple-container"></div></a>
                       <input type="hidden" name="startSpeedAnalyzertAction" id="startSpeedAnalyzertAction" value="startSpeedAnalyzer">
                    </div>
                </div>
        </fieldset>
        </form>
      ...
      <section class="ms-component-section">
                        ...
                        <div id="results-speed-analyzer-container"></div>
                        </div> <!-- /example -->
                        </section>
