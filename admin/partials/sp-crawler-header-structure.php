...
function sp_crawler_header_structure() {
...
<div style="max-width:1600px;margin:0;" class="container container-full">
    <div class="ms-paper">
            ...
            <div class="col-lg-12 ms-paper-content-container">
                <div class="ms-paper-content">
                    ...
                    <section class="ms-component-section">
                        <h2 class="section-title" style="color: #424242">Header Structure Crawler</h2>

                        <div class="alert alert-default role="alert">
                            <strong><i style="font-size:24px" class="fa fa-info-circle" aria-hidden="true"></i> !</strong> This tool will help you to checks the hierarchy and organization of headers (H1, H2, H3, etc.) on your webpages. This feature ensures that your headers are properly nested and logically arranged.
                        </div>
                   ...
                   <div class="form-group row justify-content-start">
                    <div class="col-lg-10">
                        <a href="#" onclick="startHeaderStructureCrawler(event)" id="startHeaderStructureCrawler" class="btn btn-lg btn-raised btn-default">Start Crawling<div class="ripple-container"></div></a>
                       <input type="hidden" name="startHeaderStructureAction" id="startHeaderStructureAction" value="startSpeedAnalyzer">
                    </div>
                </div>
        </fieldset>
        </form>
      ...
      <section class="ms-component-section">
                        ...
                        <div id="results-header-structure-container"></div>
                        </div> <!-- /example -->
                        </section>
