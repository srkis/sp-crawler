            ...
            <div class="col-lg-12 ms-paper-content-container">
                <div class="ms-paper-content">
                    ...
                    <section class="ms-component-section">
                        <h2 class="section-title">Image Crawler</h2>
                        <div class="alert alert-info">
                            <p><i style="font-size:24px" class="fa fa-info-circle" aria-hidden="true"></i> This tool will help you to find Google less favorable images. If you have a lots of pages / posts, we suggest you to insert a limit because crawling speed.</strong>.</p>
                        </div>
                        <form class="form-horizontal" autocomplete="off">
                            <fieldset>
                                ...
                                <div class="form-group row is-empty">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="siteUrl" placeholder="https://example.com">
                                    </div>
                                </div>
                               ...
                               <div id="loader" style="display: none;">
                                ...
                                <div class="loader-text">Crawling in progress, please wait...</div>
                                 ...
                                 <div class="form-group row justify-content-end is-empty">
                                    <label for="imagesExt" class="col-lg-2 control-label">Select Extensions</label>

                                    <div class="col-lg-10">
                                        <div class="dropdown bootstrap-select show-tick form-control">
                                        <select style="border:none !important;" id="imagesExt" multiple="" class="selectpicker form-control">
                                            <option>JPG</option>
                                            <option>JPEG</option>
                                            <option>PNG</option>
                                            <option>GIF</option>
                   ...
                   <div class="form-group row justify-content-start">
                    <div class="col-lg-10">
                        <a href="#" onclick="startImageCrawler(event)" id="startImageCrawler" class="btn btn-raised btn-info">Start Crawling<div class="ripple-container"></div></a>
                       <input type="hidden" name="crawlImageAction" id="crawlImageAction" value="startImage">
                    </div>
                </div>
        </fieldset>
        </form>
